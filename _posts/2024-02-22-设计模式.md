...
![image-20241013112546345](/assets/images/image-20241013112546345.png)

代理模式也叫做委托模式，它是一项基本的设计技巧。许多其他的模式，如状态模式、策略模式、访问者模式本质上是在更特殊的场合采用了委托模式，而且在日常的应用中，代理模式提供了非常好的访问控制。在一些著名开源软件中也经常见到它的身影，如Spring的AOP、Mybatis都使用了代理模式(准确地说是动态代理模式)。
